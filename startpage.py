...
TitleText=''                                            # The title that the window will have. 
SubText='Go on.'                              # The text that is displayed in the small area below the title.
...
importPath=r'C:\Users\Willi\Documents\Script\python\startpage.py-main\content.txt'                        # Where to find the file with the site data.
outputPath=r'C:\Users\Willi\Documents\Script\python\startpage.py-main\index.html'                        # Where to place the index.html output file. If you change this you either need to change others paths in the css too or add resources as a subfolder to that directory.
